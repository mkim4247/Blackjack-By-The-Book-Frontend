...
class Rules extends React.Component {
  render(){
    return(
      ...
      <div>
        <p>
          At the beginning of each round, players are each dealt two cards. The dealer is also dealt two cards, with one normally shown, face up, and the other hidden, face down.
        </p>
