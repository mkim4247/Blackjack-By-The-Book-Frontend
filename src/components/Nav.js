    ...
    <div>
      <div className="navbar">
        ...
        {props.user ? (
          <div
            style={
              props.user.pot > 0 ? { color: "lightGreen" } : { color: "red" }
            }
            className="left"
          >
            Pot: ${props.user.pot}
        ...
        {props.user && props.user.username !== "Guest" ? (
          <div className="left">Hands Played: {props.user.current_streak}</div>
        ) : null}
        {props.user && props.user.username !== "Guest" ? (
        ...
        >
          ...
          <tbody>
            <tr>
              <td>
                Win Percent:{" "}
                {props.user.games_played > 0
                  ? Math.ceil(
                      (props.user.wins / props.user.games_played) * 100
                    ) + "%"
                  : "0%"}
              </td>
            </tr>
            <tr>
              <td>Longest Run: {props.user.longest_streak}</td>
            </tr>
            <tr>
              <td>Largest Pot: {props.user.largest_pot}</td>
            </tr>
          </tbody>
        </table>
      ) : null}
